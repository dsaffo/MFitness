		...
		//note save handler - check create note page is active...
						if (page.id === "detailed") {
								...
								if (m == "calcon"){
										...
										node2.id = "neg_Cal" + String(count);
										document.getElementById("details").insertBefore(node2,document.getElementById("add"));
										total_calories = document.getElementById("totalc").value;
										count++;
										};
										document.getElementById("Backb").onclick = function(){
											var tempstr = "";
											for (i = 0; i < count; i++) {
												tempstr = "neg_Cal";
												tempstr = tempstr + String(i);
												total_calories = total_calories - document.getElementById(tempstr).value;
											}
										};
